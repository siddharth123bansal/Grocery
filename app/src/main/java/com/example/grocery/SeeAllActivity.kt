...
class SeeAllActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vegeList.add(VegesModel(R.drawable.localart,"local","seller: ",300,"Rakesh"))
        vegeList.add(VegesModel(R.drawable.canvas,"painting","seller: ",300,"Ramesh"))
        vegeList.add(VegesModel(R.drawable.decors,"kuxh bhi","seller",300,"Rajesh"))
        vegeList.add(VegesModel(R.drawable.canvas,"Scenrie","seller: ",300,"Mukesh"))
        vegeList.add(VegesModel(R.drawable.localart,"local","seller: ",300,"Rakesh"))
        vegeList.add(VegesModel(R.drawable.canvas,"painting","seller: ",300,"Ramesh"))
        vegeList.add(VegesModel(R.drawable.decors,"kuxh bhi","seller",300,"Rajesh"))
